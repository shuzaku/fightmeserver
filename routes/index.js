...
const characterMovesRoutes = require('./character-moves');
...
const gameplanRoutes = require('./gameplans');
const matchNoteRoutes = require('./match-notes');
const matchLogRoutes = require('./match-logs');
...
router.use('/', characterMovesRoutes);
...
router.use('/', gameplanRoutes);
router.use('/', matchNoteRoutes);
router.use('/', matchLogRoutes);
